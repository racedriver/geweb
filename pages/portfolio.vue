      ...
      <div class="col-2 lg-12 margin-bottom position-relative">
        <div class="w-layout-grid c-grid-services">
          ...
          >
            <div class="c-grid-item__text is-dark">
              <div class="overflow-hidden">
                <div class="c-grid-item__title">Fintech</div>
              </div>
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">
                  Product <span class="text-xsmall is-thin">×</span> UI design
                </div>
              </div>
            </div>
            <img
              alt="Fintech"
              class="c-grid-item__image round-border"
          ...
          >
            <div class="c-grid-item__text is-dark">
              <div class="overflow-hidden">
                <div class="c-grid-item__title">eCommerce</div>
              </div>
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">
                  Custom App
                  <span class="text-xsmall is-thin">×</span> Whitelabel Platform
                </div>
              </div>
            </div>
            <img
          ...
          >
            <div class="c-grid-item__text is-dark">
              <div class="overflow-hidden">
                <div class="c-grid-item__title">3D Gaming</div>
              </div>
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">
                  product design <span class="text-xsmall is-thin">×</span> user
                  experience
                </div>
              </div>
            </div>
          ...
          >
            <div class="c-grid-item__text is-dark">
              <div class="overflow-hidden">
                <div class="c-grid-item__title">3D web experience</div>
              </div>
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">
                  concept
                  <span class="text-xsmall is-thin">×</span> implementation
                </div>
              </div>
            </div>
            <img
          ...
          <a
            ...
            href="#"
          >
            <div class="c-grid-item__text is-dark" data-category="has-logo">
              <div class="overflow-hidden">
                <div class="c-grid-item__title">VR/AR</div>
              </div>
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">
                  design <span class="text-xsmall is-thin">×</span> development
                </div>
              </div>
            </div>
            <img
            ...
            <div class="c-grid-item__text is-dark">
              <div class="overflow-hidden">
                <div class="c-grid-item__title">
                  Self-Service Systems Integrations
                </div>
              </div>
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">
                  concept <span class="text-xsmall is-thin">×</span> realisation
                </div>
              </div>
            </div>
            <img
          ...
          >
            <div class="c-grid-item__text is-dark">
              <div class="overflow-hidden">
                <div class="c-grid-item__title">To-Do App</div>
              </div>
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">
                  design <span class="text-xsmall is-thin">×</span> development
          ...
          >
            <div class="c-grid-item__text is-dark">
              <div class="overflow-hidden">
                <div class="c-grid-item__title">Payroll Automation</div>
              </div>
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">
                  concept <span class="text-xsmall is-thin">×</span> realisation
          ...
          >
            <div class="c-grid-item__text is-dark">
              <div class="overflow-hidden">
                <div class="c-grid-item__title">Minecraft (Java)</div>
              </div>
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">
                  concept <span class="text-xsmall is-thin">×</span> realisation
          ...
          <a href="portfolio-detail.html" data-category="has-magazine" class="c-grid-item card inline-block max-w-full round-border">
            <div class="c-grid-item__text is-dark">
              ...
              <div class="overflow-hidden">
                <div class="c-grid-item__categories">website design <span class="text-xsmall is-thin">×</span> branding</div>
              </div>
            </div><img src="https://via.placeholder.com/1000x600.png?text=IMAGE 700w" sizes="(max-width: 479px) 90vw, (max-width: 752px) 93vw, 700px" alt="" class="c-grid-item__image round-border"></a-->
        </div>
      </div>
